...
global:
  ...
  portbase: 7000
  publickey: cU2WIB8cCO4BKM7Qcor16NAcsdywi3dpCwFgcRL9+A4=
...
def test_host_dns_integration_data():
    ...
    base.hosts[str(data1.uuid)] = RemoteHostRecord(
        key=data1.public_key_encoded,
    ...
    base.hosts[str(data2.uuid)] = RemoteHostRecord(
        key=data2.public_key_encoded,
        hostname=data1.hostname,
        asn=data2.asn,
        localport=7002,
        remoteport=7000,
